...
class BMPC_Dynamics:
    ...
    def eval_dot(self, z, u, z0_initial):
        """
        computes z_k+1
        ...
        :return:
        """
        return self.A @ z + self.B @ np.kron(z0_initial, u)

    def get_linearization(self, z0, z1, u, z0_initial):
        """
        ...
        B_lin = self.B.toarray() @ np.kron(z0_initial.reshape((self.nz, 1)), np.eye(self.m))

        z_next = self.eval_dot(z0, u, z0_initial)
