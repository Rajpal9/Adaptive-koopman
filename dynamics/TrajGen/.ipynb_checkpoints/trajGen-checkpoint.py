...
class trajGenerator:
    def __init__(self,waypoints,max_vel = 2,gamma = 50):
    ...
    def get_des_state(self,t):
        ...
        #return np.concatenate([pos.flatten(), vel.flatten(), accl.flatten(), jerk.flatten(), [yaw], [yawdot]]).flatten()
        return np.concatenate([pos.flatten(), vel.flatten(), accl.flatten(), jerk.flatten()]).flatten()
